...
int playAdventurer(struct gameState* state, int player)
{
...
int playEmbargo(struct gameState *state, int player, int handPos, int choice1)
{
	int currentPlayer = player;
...
int playGreatHall(struct gameState *state, int player, int handPos)
{
	int currentPlayer = player;
